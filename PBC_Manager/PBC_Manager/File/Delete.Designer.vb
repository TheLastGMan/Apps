...
Partial Class Delete
    ...
    Private Sub InitializeComponent()
        ...
        'Delete_DB
        '
        Me.Delete_DB.BackColor = System.Drawing.Color.FromArgb(CType(CType(192, Byte), Integer), CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer))
