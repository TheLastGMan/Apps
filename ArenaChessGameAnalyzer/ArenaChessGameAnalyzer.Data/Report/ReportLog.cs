...
namespace ArenaChessGameAnalyzer.Data.Report
{
	public class ReportLog
	{
		...
		public List<ReportMove> Moves { get; set; } = new List<ReportMove>(256);

		public IEnumerable<ReportMove> WhiteMoves
		{ get { return Moves.Where(f => f.Player == MoveType.WHITE); } }
		public IEnumerable<ReportMove> BlackMoves
		{ get { return Moves.Where(f => f.Player == MoveType.BLACK); } }
	}
}
