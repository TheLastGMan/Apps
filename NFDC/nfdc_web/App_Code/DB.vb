...
Public Class DB
    ...
    'Private Shared SQLstr As String = "Data Source=ryans-PC\SQLEXPRESS;Initial Catalog=FAA_NFDC;Integrated Security=True;Persist Security Info=True;MultipleActiveResultSets=True;Connect Timeout=120"
